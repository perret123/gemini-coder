...
if (!API_KEY) {
  ...
  console.error(
    "Please create a .env file in the project root (e.g., c:\\dev\\gemini-coder\\) with the line:",
...
export const modelName =
  process.env.GEMINI_MODEL_NAME || "gemini-1.5-pro-latest"; // Export modelName too
...
export function getToolsDefinition(baseDir) {
  ...
  const functionDeclarations = [
      ...
      parameters: {
        ...
        properties: {
          directoryPath: {
            type: "string",
            description:
              "Optional. Path to the directory relative to the base directory. Defaults to '.' (the base directory).",
          },
        },
      ...
      parameters: {
        ...
        properties: {
          pattern: {
            type: "string",
            description:
              "The glob pattern (e.g., 'src/**/*.ts', '*.txt'). Must be relative.",
          },
        },
        required: ["pattern"],
      },
      ...
      parameters: {
        ...
        properties: {
          regexString: {
            type: "string",
            description:
              "JavaScript regex pattern string (e.g., '/pattern/flags' or 'pattern'). Must be valid JS syntax.",
          },
          directoryPath: {
            type: "string",
            description:
              "Optional. Relative path to the directory to start searching from. Defaults to '.' (the base directory).",
          },
        },
    ...
    },
    {
      ...
      parameters: {
        ...
        properties: {
          ...
          content: {
            type: "string",
            description: "The complete, raw content to write to the file.",
          },
        },
      ...
      parameters: {
        ...
        properties: {
          sourcePath: {
            type: "string",
            description:
              "Relative source path of the file or directory to move.",
          },
          destinationPath: {
            type: "string",
      ...
      parameters: {
        ...
        properties: {
          directoryPath: {
            type: "string",
            description:
              "Relative path to the directory to delete recursively.",
          },
        },
        required: ["directoryPath"],
      },
    ...
    },
    {
      name: "task_finished",
      description:
        "Call this function ONLY when the entire user request has been successfully completed OR if you have reached an unrecoverable state (e.g., user rejected critical step, unresolvable error). This function signals the end of the task.",
      parameters: {
        type: "object",
        properties: {
          finalMessage: {
            type: "string",
            description:
              "A concise final message summarizing the outcome (e.g., 'Task completed successfully.', 'File updated as requested.', 'Failed to delete file due to user rejection.').",
          },
        },
